...
public class DrawerToast{
     ...
     * 每条Toast显示持续时间
     */
    private static final int TIME_DURATION = 2800;
    ...
    private void initView(){
        ...
        gapView.setLayoutParams(new LayoutParams(screenWidth, screenHeight/6));
