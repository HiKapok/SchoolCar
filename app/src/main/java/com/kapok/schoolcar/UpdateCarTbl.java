...
public class UpdateCarTbl extends MyAsyncTask{
    ...
    UpdateCarTbl(String url,Context context,boolean creat,ProgressDialog progressDialog,String textString) {
        // TODO Auto-generated method stub
        super(progressDialog,textString);
                        ...
                        while(mat.find()){
                            ...
                            if(creat){
                                ...
                                if(versionDay.compareTo(temps)>0){
                                    versionDay = temps;
                                    AlertDialog.Builder alert = new AlertDialog.Builder(context).setTitle("发现新版本数据库").setMessage("确定要更新数据库吗？");
